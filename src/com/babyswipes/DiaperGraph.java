...
public class DiaperGraph extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       //**************Database sim code******************
        ...
        // Get number of last entries to display from user
        
        AlertDialog.Builder alert = new AlertDialog.Builder(this);

        alert.setTitle("Data Graph Input");
        alert.setMessage("Display how many data points?");
        ...
        public void onClick(DialogInterface dialog, int whichButton) {
          ...
          //int numRecent = 4;
          int numRecent = Integer.parseInt(value);
        ...
        // END Get number of last entries to display from user
