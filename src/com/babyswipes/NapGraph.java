...
public class NapGraph extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nap_graph);
       ...
       //**************Database sim code******************
        ...
        // Pull last 3 entries in the database.
        int numRecent = 3;
        
        Number[] time = new Number[numRecent];
        time = mDataBase.getRecentSwipesForTag("Nap", numRecent);
        ...
        mySimpleXYPlot.setRangeLabel("# of Naps");
        ...
        mySimpleXYPlot.setDomainValueFormat(new Format() {
            ...
            public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
                ...
                // because our time stamps are in seconds and SimpleDateFormat expects milliseconds
                // we multiply our time stamp by 1000:
