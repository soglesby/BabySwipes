...
public class MedicineGraph extends BaseActivity {
    private static final String TAG = "MedicineGraph";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medicine_graph);
        ...
        mDataBase.addSwipe("Medicine", times + 100);
        mDataBase.addSwipe("Medicine", times + 520);
        mDataBase.addSwipe("Medicine", times + 800);
        mDataBase.addSwipe("Medicine", times + 907);
        */     
       ...
       //**************Database sim code******************
        ...
        // Pull last 4 entries in the database.
        int numRecent = 4;
        
        Number[] time = new Number[numRecent];
        time = mDataBase.getRecentSwipesForTag("Medicine", numRecent);
        ...
        mySimpleXYPlot.setRangeLabel("# of Medicine Administered");
