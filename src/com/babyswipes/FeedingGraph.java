...
public class FeedingGraph extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feeding_graph);
        ...
        mDataBase.addSwipe("Feeding", times + 100);
        mDataBase.addSwipe("Feeding", times + 220);
        mDataBase.addSwipe("Feeding", times + 300);
        mDataBase.addSwipe("Feeding", times + 307);
        mDataBase.addSwipe("Feeding", times + 500);
        mDataBase.addSwipe("Feeding", times + 510);
        mDataBase.addSwipe("Feeding", times + 578);
        mDataBase.addSwipe("Feeding", times + 599);     
       ...
       //**************Database sim code*****************
        ...
        time = mDataBase.getRecentSwipesForTag("Feeding", numRecent);
        ...
        Number[] timeGraph = new Number[numRecent+1]; //new array with exrta element
        ...
        mySimpleXYPlot.setRangeLabel("# of Feedings");
